...
\begin{figure}[ht]
\centering
\includegraphics[trim = 10mm 48mm 10mm 48mm, clip,width=.75\textwidth]{MWCostPerkWhVsLEGP0105}
...
% outline:
% introduction
	% main idea: knowing when shortfalls occur helps design
	% describe analysis behind figure
		% we histogram bin by hour to determine most frequent shortfalls
		% we overlay the average load profile
		% these should ideally be complementary

% describe specific figures
	% two different loads, nighttime only vs. constant loads
	% where is data from (simulated, types of loads)
	% what are the significant differences between the two
	
% specific implications for designers
	% despite high LEGP, loss events may be at tolerable time
	% more implications
...
\begin{figure}[ht]  
  \centering
    \includegraphics[trim = 8mm 48mm 8mm 48mm, clip,width=.75\textwidth]{MaliFridgeCostPerkWhVsLEGP}
...
\begin{figure}[ht]
\centering
\includegraphics[trim = 8mm 48mm 8mm 48mm, clip,width=.75\textwidth]{timeOfShortfallByHourCount0105}
...
\begin{figure}[ht]
\centering
\includegraphics[trim = 10mm 48mm 10mm 48mm, clip,width=.75\textwidth]{monthlyLEGPMali0105}
