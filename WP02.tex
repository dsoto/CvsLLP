...
\begin{figure}
\centering
\includegraphics[trim = 25mm 180mm 95mm 25mm, clip,width=.5\textwidth]{DesignProcessFlow.pdf}
...
%When utilizing our proposed methodology to facilitate micro-grid design decisions, there are two primary questions which micro-grid designers must consider.
%The first is, "what are the high priority uses of electricity?"
% the electricity using devices will help specify reliability requirements. 
%The second important question is, "when does high priority electricity demand occur?"
%Answering this question will help to ensure energy shortfalls do not occur when energy is most needed.
...
\begin{figure}[ht] 
  \centering
    \includegraphics[trim = 0mm 70mm 0mm 68mm, clip,width=.95\textwidth]{energyBalance2.pdf}
