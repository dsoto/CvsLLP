...
Within this section, we describe our methodology of identifying the lowest cost system that uses real or
...
As illustrated by figure \ref{ConfigSumm}, the current micro-grid configuration has an annual \emph{LEGP} of 0.054.
