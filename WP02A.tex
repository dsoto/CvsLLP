...
%
% Create Cost vs Reliability Curve
%
\begin{figure}[ht] 
  \centering
...
The cost versus \emph{LEGP} curve illustrated as figure \ref{MaliFridgeCostPerkWhVsLEGP} is of the micro-grid with a refrigerator base load. The weather profile used by the model is of Segou, Mali.
When analyzing figure \ref{MaliFridgeCostPerkWhVsLEGP}, we observe a knee in the curve where \emph{LEGP} is approximately equal to 0.05.
...
Figure \ref{MaliFridgeCostPerkWhVsLEGP} has a fundamentally different shape than the cost versus reliability curve created by Wissem et al. \cite{}. 
...
Cost versus \emph{LEGP} curves, like that represented in figure \ref{MaliFridgeCostPerkWhVsLEGP}, provide a means to understand the marginal cost of additional micro-grid capacity. 
